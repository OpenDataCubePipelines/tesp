...
def write_tif_from_dataset(
    dataset, out_fname, options, config_options, overviews=True, nodata=None, geobox=None
):
    """
...
def write_tif_from_file(dataset: str, out_fname, options, config_options, overviews=True):
    ...
    with tempfile.TemporaryDirectory(dir=dirname(out_fname), prefix="cogtif-") as tmpdir:
