...
h5py = pytest.importorskip(
    "h5py", reason="Extra dependencies needed to run wagl package test." "Try pip install eodatasets3[wagl]",
)

# This test dataset comes from running 'tests/integration/h5downsample.py' on
# a real wagl output.
WAGL_INPUT_PATH: Path = Path(__file__).parent / "data/wagl-input/LC80920842016180LGN01/LC80920842016180LGN01.wagl.h5"

# The matching Level1 metadata (produced by landsat_l1_prepare.py)
L1_METADATA_PATH: Path = Path(__file__).parent / "data/wagl-input/LC08_L1TP_092084_20160628_20170323_01_T1.yaml"

# The fmask image
FMASK_IMAGE_PATH: Path = Path(__file__).parent / "data/wagl-input/LC80920842016180LGN01/LC80920842016180LGN01.fmask.img"

# The fmask document path
FMASK_DOC_PATH: Path = Path(__file__).parent / "data/wagl-input/LC80920842016180LGN01/LC80920842016180LGN01.fmask.yaml"

# The gqa document path
GQA_DOC_PATH: Path = Path(__file__).parent / "data/wagl-input/LC80920842016180LGN01/LC80920842016180LGN01.gqa.yaml"

# tesp document path
TESP_DOC_PATH: Path = Path(__file__).parent / "data/wagl-input/LC80920842016180LGN01/LC80920842016180LGN01.tesp.yaml"
...
def expected_wagl_output(tmp_path):
    return {
        ...
        "grids": {
            "default": {
                "shape": [79, 78],
                "transform": [2981.153846153846, 0.0, 360585.0, 0.0, -2966.2025316455697, -3713085.0, 0.0, 0.0, 1.0,],
            },
            "rg0": {
                "shape": [157, 156],
                "transform": [1490.4807692307693, 0.0, 360592.5, 0.0, -1492.452229299363, -3713092.5, 0.0, 0.0, 1.0,],
            },
            "rg0_oa_dsm_smoothed": {
                "shape": [167, 166],
                "transform": [1497.198795180723, 0.0, 352582.5, 0.0, -1499.0119760479042, -3705082.5, 0.0, 0.0, 1.0,],
            },
            "rg1_oa_dsm_smoothed": {
                "shape": [84, 83],
                "transform": [2994.5783132530123, 0.0, 352575.0, 0.0, -2980.357142857143, -3705075.0, 0.0, 0.0, 1.0,],
            },
        },
        ...
        "measurements": {
            "oa_fmask": {
                ...
                "path": str(
                    tmp_path / "LC80920842016180LGN01/LC80920842016180LGN01.converted.datasets.h5"  # noqa: W503
                ),
            },
            "rg0_lambertian_panchromatic": {
                "grid": "rg0",
                "layer": "//LC80920842016180LGN01/RES-GROUP-0/STANDARDISED-PRODUCTS/REFLECTANCE/LAMBERTIAN/BAND-8",
                "path": str(tmp_path / "LC80920842016180LGN01/LC80920842016180LGN01.wagl.h5"),
            },
        ...
        "product": {"href": "https://collections.dea.ga.gov.au/product/ga_ls8c_ard_3", "name": "ga_ls8c_ard_3",},
        "properties": {
            ...
            "odc:processing_datetime": datetime(2019, 7, 11, 23, 29, 29, 21245, tzinfo=timezone.utc),
...
def test_package(tmp_path, expected_wagl_output: dict):
    for eods_granule in Granule.for_path(
        WAGL_INPUT_PATH, granule_names, L1_METADATA_PATH, FMASK_IMAGE_PATH, FMASK_DOC_PATH, GQA_DOC_PATH, TESP_DOC_PATH,
    ):
